...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _router__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./router */ "./src/cat/router.js");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "router", function() { return _router__WEBPACK_IMPORTED_MODULE_0__["router"]; });
...
/* harmony import */ var koa_router__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! koa-router */ "koa-router");
/* harmony import */ var koa_router__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(koa_router__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _store__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./store */ "./src/cat/store.js");
...
router.get('/:id', async ctx => {
  const userId = ctx.state.user._id;
  const cat = await _store__WEBPACK_IMPORTED_MODULE_1__["default"].findOne({
    _id: ctx.params.id
  });
  const response = ctx.response;
...
const createCat = async (ctx, cat, response) => {
  try {
    const userId = ctx.state.user._id;
    cat.userId = userId;
    response.body = await _store__WEBPACK_IMPORTED_MODULE_1__["default"].insert(cat);
    response.status = 201; // created
...
/*!**************************!*\
  !*** ./src/cat/store.js ***!
  \**************************/
/*! exports provided: CatStore, default */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "CatStore", function() { return CatStore; });
/* harmony import */ var nedb_promise__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! nedb-promise */ "nedb-promise");
/* harmony import */ var nedb_promise__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(nedb_promise__WEBPACK_IMPORTED_MODULE_0__);
...
/* harmony default export */ __webpack_exports__["default"] = (new CatStore({
  filename: './db/cats.json',
  autoload: true
}));
...
/* harmony import */ var _cat__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./cat */ "./src/cat/index.js");
...
protectedApiRouter.use('/item', _cat__WEBPACK_IMPORTED_MODULE_6__["router"].routes());
app.use(protectedApiRouter.routes()).use(protectedApiRouter.allowedMethods());
server.listen(3001, '192.168.1.3');
...
module.exports = __webpack_require__(/*! /Users/dianasalavastru/Downloads/my-node-server-auth/src/index.js */"./src/index.js");
